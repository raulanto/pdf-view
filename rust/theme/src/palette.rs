...
/// Paleta de respaldo cuando no hay tema Omarchy disponible.
...
/// Parsea el TOML de colores de Omarchy y devuelve la paleta normalizada.
...
/// Lista de rutas candidatas para el archivo de colores TOML de Omarchy.
/// `PDF_VIEW_THEME_FILE` anula todas las rutas predeterminadas.
...
/// Lee y valida el archivo TOML de colores en `path`.
pub fn read_palette(path: &PathBuf) -> Result<Value, String> {
