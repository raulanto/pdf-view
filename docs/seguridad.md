...
Las preferencias tienen límite de 16 KiB. Se rechazan enlaces simbólicos y entradas no regulares al leer; los datos guardados deben pasar validación de campos, rangos, colores e idiomas y de atajos únicos. El archivo nuevo se crea con permisos 0600 y se reemplaza atómicamente. La configuración no cambia el aislamiento ni los presupuestos del worker. El desmarcado parcial también rechaza resultados de más de 128 segmentos por marca.
